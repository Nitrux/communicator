...
checkinstall -D -y \
	...
	--requires="libc6,libkf5contacts5,libkf5coreaddons5,libkf5i18n5,libkf5kiocore5,libkf5people5,libkf5service5,libqt5core5a,libqt5gui5,libqt5qml5,libqt5sql5,libqt5widgets5,mauikit-accounts-git \(\>= 2.2.2+git\),mauikit-filebrowsing-git \(\>= 2.2.2+git\),mauikit-git \(\>= 2.2.2+git\)" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
